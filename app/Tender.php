...
class Tender extends Model
{
	...
	protected $fillable = array('department_id','tender_number', 'name_of_the_work', 'tender_id', 'tender_type_id', 'cost_of_work', 'ernest_money_deposit', 'cost_of_tender', 'completion_period', 'validity_of_offer', 'issue_from', 'issue_to', 'receipt_of_offer', 'tender_opening_date', 'nit', 'tender', 'corrigendum', 'added_by');
